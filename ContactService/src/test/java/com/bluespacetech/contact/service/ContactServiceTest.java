...
public class ContactServiceTest {
	...
	public void testCreateContact() throws BusinessException {
		...
		Contact_ContactGroup contact_ContactGroup1 = new Contact_ContactGroup();
		contact_ContactGroup1.setContact(contact1);
		contact_ContactGroup1.setContactGroup(contactGroup1);
		contact_ContactGroup1.setActive(true);
		contact_ContactGroup1.setUnSubscribed(false);

		Contact_ContactGroup contact_ContactGroup2 = new Contact_ContactGroup();
		contact_ContactGroup2.setContact(contact2);
		contact_ContactGroup2.setContactGroup(contactGroup2);
		contact_ContactGroup2.setActive(true);
		contact_ContactGroup2.setUnSubscribed(false);
		
		Collection<Contact_ContactGroup> contact_ContactGroups = new ArrayList<>();
		contact_ContactGroups.add(contact_ContactGroup1);
		contact_ContactGroups.add(contact_ContactGroup2);
		
		contact1.getContact_ContactGroups().addAll(contact_ContactGroups);
		contact2.getContact_ContactGroups().addAll(contact_ContactGroups);
		contact3.getContact_ContactGroups().addAll(contact_ContactGroups);
		contact4.getContact_ContactGroups().addAll(contact_ContactGroups);
		contact5.getContact_ContactGroups().addAll(contact_ContactGroups);
		contact6.getContact_ContactGroups().addAll(contact_ContactGroups);
